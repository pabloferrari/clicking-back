...
class EndMeetingRequest extends FormRequest
{
    ...
    {
        return [
            'meetingId'  =>  'required|string|exists:bbb_meetings,meetingId'
        ];
    }
    ...
    public function after($validator)
    {
        ...
        if(count($validator->errors()) === 0){
            ...
            $meeting = Meeting::where('meetingId',$this->input('meetingId'))->first();
            $moderatorId = $meeting->meetingRequest->user_id;
            $institutionId = $meeting->meetingRequest->institution_id;
